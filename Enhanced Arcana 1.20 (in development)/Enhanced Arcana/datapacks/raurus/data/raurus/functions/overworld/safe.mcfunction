...
execute at @e[tag=zombified_mage,scores={time=45}] run summon marker ~ ~ ~ {Tags:["zombified_orb"]}
execute at @e[tag=zombified_mage,scores={time=45}] positioned ~ ~1.5 ~ run particle soul_fire_flame ^ ^ ^1 0.1 0.1 0.1 0.09 10 normal
execute at @e[tag=zombified_mage,scores={time=45}] run playsound minecraft:entity.allay.item_taken ambient @a[distance=..10] ~ ~ ~ 10 1.00
execute at @e[tag=zombified_mage,scores={time=45}] run playsound minecraft:entity.allay.item_taken ambient @a[distance=..10] ~ ~ ~ 10 2.00
execute at @e[tag=zombified_mage,scores={time=45}] run playsound minecraft:entity.allay.item_taken ambient @a[distance=..10] ~ ~ ~ 10 1.50
execute at @e[tag=zombified_mage,scores={time=45}] run playsound minecraft:entity.allay.item_taken ambient @a[distance=..10] ~ ~ ~ 10 1.80
...
execute at @e[tag=zombified_orb,type=marker,scores={time=1..}] as @a[distance=..2] run damage @s 4 magic
execute at @e[tag=zombified_orb,type=marker,scores={time=1..}] as @a[distance=..2] run particle soul_fire_flame ~ ~ ~ 0.1 0.1 0.1 0.09 10 normal
execute at @e[tag=zombified_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 2
execute at @e[tag=zombified_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1
execute at @e[tag=zombified_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1.5
...
execute at @e[tag=zombified_druid,scores={time=45}] run summon marker ~ ~ ~ {Tags:["druid_orb"]}
execute at @e[tag=zombified_druid,scores={time=45}] positioned ~ ~1.5 ~ run particle minecraft:happy_villager ^ ^ ^1 0.1 0.1 0.1 0.09 10 normal
execute at @e[tag=zombified_druid,scores={time=45}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 10 1.00
execute at @e[tag=zombified_druid,scores={time=45}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 10 2.00
execute at @e[tag=zombified_druid,scores={time=45}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 10 1.50
execute at @e[tag=zombified_druid,scores={time=45}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 10 1.80
...
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run damage @s 2 magic
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run tag @s add poisoned
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run particle minecraft:happy_villager ~ ~ ~ 0.1 0.1 0.1 9 10 normal
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 2
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1
execute at @e[tag=druid_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1.5
...
execute at @e[tag=druid_legion,type=marker,scores={time=70..}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 0.6 1
execute at @e[tag=druid_legion,type=marker,scores={time=70..}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 0.6 1.5
execute at @e[tag=druid_legion,type=marker,scores={time=70..}] run playsound minecraft:entity.zombie_villager.converted ambient @a[distance=..10] ~ ~ ~ 0.6 2
execute at @e[tag=druid_legion,type=marker,scores={time=70..}] run particle flash ~ ~ ~ 0 0 0 0 10 normal
execute at @e[tag=druid_legion,type=marker,scores={time=70..}] run summon zombie ~ ~ ~ {Tags:["selected"],DeathLootTable:"minecraft:empty"}
kill @e[tag=druid_legion,type=marker,scores={time=70..}]
...
execute at @e[tag=dark_mage,scores={time=45}] run summon marker ~ ~ ~ {Tags:["dark_orb"]}
execute at @e[tag=dark_mage,scores={time=45}] positioned ~ ~1.5 ~ run particle ash ^ ^ ^1 0.1 0.1 0.1 0.09 10 normal
execute at @e[tag=dark_mage,scores={time=45}] run playsound minecraft:entity.zombie_villager.cure ambient @a[distance=..10] ~ ~ ~ 1 1.00
execute at @e[tag=dark_mage,scores={time=45}] run playsound minecraft:entity.zombie_villager.cure ambient @a[distance=..10] ~ ~ ~ 1 2.00
execute at @e[tag=dark_mage,scores={time=45}] run playsound minecraft:entity.zombie_villager.cure ambient @a[distance=..10] ~ ~ ~ 1 1.50
execute at @e[tag=dark_mage,scores={time=45}] run playsound minecraft:entity.zombie_villager.cure ambient @a[distance=..10] ~ ~ ~ 1 1.80
...
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run damage @s 1 magic
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run tag @s add rooted
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run particle ash ~ ~ ~ 0.1 0.1 0.1 9 10 normal
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 2
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1
execute at @e[tag=dark_orb,type=marker,scores={time=1..}] as @a[distance=..2] run playsound minecraft:block.beacon.deactivate ambient @a[distance=..10] ~ ~ ~ 1 1.5
...
execute as @e[tag=electric_phantom,scores={time=80..}] at @s run summon marker ~ ~ ~ {Tags:["summon_lightning_bolt"]}
execute as @e[tag=electric_phantom,scores={time=80..}] at @s run summon marker ~ ~ ~ {Tags:["summon_lightning_bolt"]}
execute as @e[tag=electric_phantom,scores={time=80..}] at @s run summon marker ~ ~ ~ {Tags:["summon_lightning_bolt"]}
execute as @e[tag=electric_phantom,scores={time=80..}] at @s run summon marker ~ ~ ~ {Tags:["summon_lightning_bolt"]}
execute as @e[tag=electric_phantom,scores={time=80..}] at @s run summon marker ~ ~ ~ {Tags:["summon_lightning_bolt"]}
scoreboard players set @e[tag=electric_phantom,scores={time=80..}] time 0
...
execute as @a at @s if biome ~ ~ ~ minecraft:cherry_grove run scoreboard players add @s flower_time 1
