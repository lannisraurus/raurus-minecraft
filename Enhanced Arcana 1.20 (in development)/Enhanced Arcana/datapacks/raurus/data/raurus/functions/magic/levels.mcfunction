...
#DEX
execute as @a[scores={dex=0},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 3.5
execute as @a[scores={dex=1},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 3.6
execute as @a[scores={dex=2},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 3.7
execute as @a[scores={dex=3},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 3.8
execute as @a[scores={dex=4},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 3.9
execute as @a[scores={dex=5},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.0
execute as @a[scores={dex=6},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.1
execute as @a[scores={dex=7},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.2
execute as @a[scores={dex=8},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.3
execute as @a[scores={dex=9},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.4
execute as @a[scores={dex=10},tag=update_player] run attribute @s minecraft:generic.attack_speed base set 4.5
...
#AGI
execute as @a[scores={agi=0},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.088
execute as @a[scores={agi=1},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.090
execute as @a[scores={agi=2},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.092
execute as @a[scores={agi=3},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.094
execute as @a[scores={agi=4},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.096
execute as @a[scores={agi=5},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.098
execute as @a[scores={agi=6},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.1
execute as @a[scores={agi=7},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.106
execute as @a[scores={agi=8},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.112
execute as @a[scores={agi=9},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.12
execute as @a[scores={agi=10},tag=update_player] run attribute @s minecraft:generic.movement_speed base set 0.13
...
execute as @a[scores={vit=0},tag=update_player] run attribute @s minecraft:generic.max_health base set 16
execute as @a[scores={vit=1},tag=update_player] run attribute @s minecraft:generic.max_health base set 18
execute as @a[scores={vit=2},tag=update_player] run attribute @s minecraft:generic.max_health base set 20
execute as @a[scores={vit=3},tag=update_player] run attribute @s minecraft:generic.max_health base set 22
execute as @a[scores={vit=4},tag=update_player] run attribute @s minecraft:generic.max_health base set 24
execute as @a[scores={vit=5},tag=update_player] run attribute @s minecraft:generic.max_health base set 25
execute as @a[scores={vit=6},tag=update_player] run attribute @s minecraft:generic.max_health base set 26
execute as @a[scores={vit=7},tag=update_player] run attribute @s minecraft:generic.max_health base set 27
execute as @a[scores={vit=8},tag=update_player] run attribute @s minecraft:generic.max_health base set 28
execute as @a[scores={vit=9},tag=update_player] run attribute @s minecraft:generic.max_health base set 29
execute as @a[scores={vit=10},tag=update_player] run attribute @s minecraft:generic.max_health base set 30


#STR
execute as @a[scores={str=0},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 0.5
execute as @a[scores={str=1},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 0.6
execute as @a[scores={str=2},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 0.7
execute as @a[scores={str=3},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 0.8
execute as @a[scores={str=4},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 0.9
execute as @a[scores={str=5},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.0
execute as @a[scores={str=6},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.1
execute as @a[scores={str=7},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.2
execute as @a[scores={str=8},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.3
execute as @a[scores={str=9},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.4
execute as @a[scores={str=10},tag=update_player] run attribute @s minecraft:generic.attack_damage base set 1.5
