...
execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ #minecraft:crops unless block ~ ~0.1 ~ #minecraft:crops[age=7] unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["grow_crop","bottany_interaction"]}

execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ cornflower unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["enchant_flower","bottany_interaction"]}
execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ blue_orchid unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["enchant_flower","bottany_interaction"]}
execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ allium unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["enchant_flower","bottany_interaction"]}

execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ brown_mushroom unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["enchant_shroom","bottany_interaction"]}
execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ red_mushroom unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["curse_shroom","bottany_interaction"]}

execute as @a[tag=knows_bottany,scores={is_sneaking=1..}] at @s if block ~ ~0.1 ~ #minecraft:saplings unless entity @e[distance=..0.1,tag=bottany_interaction] run summon interaction ~ ~ ~ {width:0.5f,height:1.1f,Tags:["sap_life","bottany_interaction"]}


execute as @e[tag=bottany_interaction] at @s unless entity @a[distance=..0.1,scores={is_sneaking=1..}] run kill @s
...
execute as @e[tag=grow_crop] at @s on target run scoreboard players add @s[scores={mana=50..}] exp 4
...
execute as @e[tag=enchant_flower] at @s on target unless entity @e[tag=enchanted_flower,distance=..1] run scoreboard players add @s[scores={blood=50..}] exp 6
...
execute as @e[tag=enchant_shroom] at @s on target unless entity @e[tag=enchanted_shroom,distance=..1] run scoreboard players add @s[scores={blood=50..}] exp 7
...
execute as @e[tag=curse_shroom] at @s on target unless entity @e[tag=enchanted_shroom,distance=..1] run scoreboard players add @s[scores={blood=20..}] exp 2
...
execute as @e[tag=sap_life] at @s on target run scoreboard players add @s[scores={mana=50..}] exp 3
