...
execute in minecraft:the_nether run tag @e[distance=0..,type=stray,tag=!selected] add fire_sprite_select
...
execute as @e[tag=fire_wave,type=marker] at @s run function raurus:single/fire_wave

execute at @e[tag=fire_sprite,scores={time2=45}] run function raurus:single/fireballs
...
execute in minecraft:the_nether run tag @e[distance=0..,type=wither_skeleton,tag=!selected] add rot_wizard_select
...
execute as @e[tag=rot_wave,type=marker] at @s run function raurus:single/rot_wave


execute at @e[tag=rot_wizard,scores={time2=45}] run function raurus:single/rot_legion
...
execute as @e[tag=rot_legion,type=marker,scores={time=70..}] at @s run function raurus:single/wither_skeleton_spawn

execute at @e[tag=rot_wizard,scores={time3=45}] run function raurus:single/rot_fangs
...
scoreboard players remove @a[scores={fire=1..}] freeze 40 
...
execute in minecraft:the_nether as @e[distance=0..,type=item,nbt={OnGround:1b,Item:{tag:{spawn_bonfire:1b}}}] at @s run function raurus:single/place_bonfire
...
execute as @e[tag=warm_up,scores={time=6000..}] at @s run function raurus:single/destroy_bonfire
