...
execute positioned as @a[tag=lobby_tp,tag=!invisible,tag=!ghost,tag=!in_interstice] in minecraft:overworld run function raurus:particles/alchemy4
execute positioned as @a[tag=lobby_tp,tag=!invisible,tag=!ghost,tag=in_interstice] in raurus:interstice run function raurus:particles/alchemy3
